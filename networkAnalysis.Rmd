...
compare_12 <- NCT(pclItem_na,pclNoMed_na, it=5000, binary.data=FALSE, test.edges=TRUE, edges='all', progressbar=TRUE, test.centrality = TRUE, p.adjust.methods = "fdr")
```
...
ega<-EGA(pclItems_noCluster, plot.EGA = TRUE, steps = 1) # here they find the four clusters like DSM
```
