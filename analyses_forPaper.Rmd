...
vaDatclean$MARRIED <- relevel(vaDatclean$MARRIED, "1")
...
model1 <- glm(censore30 ~ AGE_OCT01 + PSYCTHR + MARRIED + sumComorbid + sumMed, data=threeMeds_dat, family = binomial)
summary(model1)
...
print(plot_summs(model1, scale = TRUE, exp = TRUE, colors = "Qual1", 
           coefs = c("Age" = "AGE_OCT01", "# Psych Sessions" = "PSYCTHR",
                     "Not Married" = "MARRIED", "Comorbidity Index" = "sumComorbid", "# of Medications" = "sumMed")))
```
...
```{r}
plot_summs(model1,model2, model3, scale = TRUE, exp = TRUE) #, colors = "Qual1") #, 
       #    coefs = c("Age" = "AGE_OCT01", "# Psych Sessions" = "PSYCTHR",
        #             "Not Married" = "MARRIED", "Comorbidity Index" = "sumComorbid", "# of Medications" = "sumMed")))
```
