...
```{r}
# Bootstrap 1:
boot1 <- bootnet(n2, nCores = 10, nBoots = 2000, type = "nonparametric") 
plot(boot1, labels = F, order = "sample")  + theme_minimal()
# now lets look at subjects
boot2 <- bootnet(n2, nCores = 10, nBoots = 2000, type = "case")
plot(boot2, labels = F, order = "sample") + theme_minimal()

# Measure Centrality stability for EI - to check later for differences
boot3 <- bootnet(n2, nCores = 10, nBoots = 2000, statistics = "expectedInfluence", type = "nonparametric")
...
```{r}
# Bootstrap 1:
boot1_phq <- bootnet(n2_phq, nCores = 10, nBoots = 2000, type = "nonparametric") 
plot(boot1_phq, labels = F, order = "sample")  + theme_minimal()
# now lets look at subjects
boot2_phq <- bootnet(n2_phq, nCores = 10, nBoots = 2000, type = "case")
