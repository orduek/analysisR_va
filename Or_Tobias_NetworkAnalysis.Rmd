...
pcl_only_long <- pivot_longer(pcl_only, cols = c(pclOnly_EI, pclOnly_R2_1))
ggplot(pcl_only_long, aes(x=labels, y=value, color = name, group = name)) + geom_point() + geom_line() + theme_minimal() + ylab("EI/R^2") + xlab("node") + coord_flip()
...
pclPhq_long <- pivot_longer(pclPhq, cols = c(pclPhq_EI, pclPhq_R2_2))
ggplot(pclPhq_long, aes(x=labels_2, y=value, color = name, group = name)) + geom_point() + geom_line() + theme_minimal() + ylab("EI/R^2") + xlab("node") + coord_flip()
